...
HD_PWD='C:/OCDS/cloude-detection-accelerator/mlp_ip_generater/mlp_ip_generater.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_cloud_detection_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mlp_cloud_detection_wrapper.tcl -notrace
