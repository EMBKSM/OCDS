...
HD_PWD='C:/OCDS/cloude-detection-accelerator/mlp_ip_generater/mlp_ip_generater.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_cloud_detection_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mlp_cloud_detection_wrapper.tcl
