...
-- Date        : Wed Feb 11 14:26:34 2026
-- Host        : Legion running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/OCDS/cloude-detection-accelerator/mlp_ip_generater/mlp_ip_generater.gen/sources_1/bd/mlp_cloud_detection/ip/mlp_cloud_detection_ddr4_0_0/mlp_cloud_detection_ddr4_0_0_stub.vhdl
-- Design      : mlp_cloud_detection_ddr4_0_0
...
entity mlp_cloud_detection_ddr4_0_0 is
  Port ( 
  ...
  attribute CORE_GENERATION_INFO of mlp_cloud_detection_ddr4_0_0 : entity is "DDR4_SDRAM, DDR4_SDRAM,{x_ipProduct=Vivado 2017.2.0,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=DDR4_SDRAM,x_ipVersion=2.2, Controller_Type = DDR4_SDRAM, Time_Period = 833, Input_Clock_Period = 3332, Memory_Type = Components, Memory_Part = MT40A256M16LY-062E, Ecc = false, Cas_Latency = 18, Cas_Write_Latency = 12, DQ_Width = 16, Chip_Select = true, Data_Mask = DM_NO_DBI, MEM_ADDR_ORDER = ROW_COLUMN_BANK,  Is_AXI_Enabled = true , Slot_cofiguration =  Single , Clamshell_cofiguration =  false ,IS_FASTER_SPEED_RAM = No, Is_custom_part = false, Memory_Voltage = 1.2V, Phy_Only = Complete_Memory_Controller, Debug_Port = Disable, Burst_Length = 8, System_Clock = Differential, AXI_Selection = true, AXI_Data_Width = 128,  AXI_ArbitrationScheme = RD_PRI_REG, AXI_Narrow_Burst = false, Simulation_Mode = BFM, Debug_Mode = Disable, Example_TG = SIMPLE_TG, Self_Refresh = false, Save_Restore = false, Enable_LVAUX = false,MicroBlaze_ECC = false,  Specify_MandD = false, CLKBOUT_MULT = 5, DIVCLK_DIVIDE = 1, CLKOUT0_DIVIDE = 5}";
  attribute dont_touch : string;
  attribute dont_touch of mlp_cloud_detection_ddr4_0_0 : entity is "true";
end mlp_cloud_detection_ddr4_0_0;

architecture stub of mlp_cloud_detection_ddr4_0_0 is
