...
set C_modelArgList {
	...
	{ meta_stream int 32 regular {fifo 0 volatile } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "meta_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ out_stream_TDATA sc_out sc_lv 32 signal 64 } 
	{ out_stream_TVALID sc_out sc_logic 1 outvld 67 } 
	{ out_stream_TREADY sc_in sc_logic 1 outacc 67 } 
	{ out_stream_TKEEP sc_out sc_lv 4 signal 65 } 
	{ out_stream_TSTRB sc_out sc_lv 4 signal 66 } 
	{ out_stream_TLAST sc_out sc_lv 1 signal 67 } 
	{ meta_stream_dout sc_in sc_lv 32 signal 68 } 
	{ meta_stream_empty_n sc_in sc_logic 1 signal 68 } 
	{ meta_stream_read sc_out sc_logic 1 signal 68 } 
	{ meta_stream_num_data_valid sc_in sc_lv 7 signal 68 } 
	{ meta_stream_fifo_cap sc_in sc_lv 7 signal 68 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "meta_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "meta_stream", "role": "dout" }} , 
 	{ "name": "meta_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "meta_stream", "role": "empty_n" }} , 
 	{ "name": "meta_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "meta_stream", "role": "read" }} , 
...
set Spec2ImplPortList { 
	...
	meta_stream { ap_fifo {  { meta_stream_dout fifo_data_out 0 32 }  { meta_stream_empty_n fifo_status_empty 0 1 }  { meta_stream_read fifo_data_in 1 1 }  { meta_stream_num_data_valid fifo_update 0 7 }  { meta_stream_fifo_cap fifo_data 0 7 } } }
}
