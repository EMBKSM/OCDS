...
entity cloud_mlp_top_fifo_w15_d2_S is 
    generic (
...
architecture rtl of cloud_mlp_top_fifo_w15_d2_S is
...
------------------------Component----------------------
    component cloud_mlp_top_fifo_w15_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 15;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cloud_mlp_top_fifo_w15_d2_S_ShiftReg : cloud_mlp_top_fifo_w15_d2_S_ShiftReg
    generic map (
...
entity cloud_mlp_top_fifo_w15_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 15;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cloud_mlp_top_fifo_w15_d2_S_ShiftReg;

architecture rtl of cloud_mlp_top_fifo_w15_d2_S_ShiftReg is
